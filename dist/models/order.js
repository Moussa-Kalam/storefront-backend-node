...
var OrderModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not retrieve list of orders. Error: ".concat(err_1));
    ...
    OrderModel.prototype.create = function (o) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, user, sql, result, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query('SELECT * FROM users WHERE id = $1', [o.user_id])];
                    case 2:
                        user = _a.sent();
                        if (user.rows.length === 0) {
                            throw new Error("User with id ".concat(o.user_id, " does not exist"));
                        }
    ...
    OrderModel.prototype.showCurrent = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OrderModel.prototype.showComplete = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
