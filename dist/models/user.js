        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'UPDATE users SET user_name=$2, first_name=$3, last_name= $4, user_password=$5 WHERE id=$1 RETURNING user_name, first_name, last_name';
                        return [4 /*yield*/, conn.query(sql, [
                                u.id,
                                u.user_name,
                                u.first_name,
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not update user ".concat(u.id, ". Error ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
